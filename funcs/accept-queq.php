...
if ($reservation["status"] != "waiting") {
  setError("การจองนี้ถูกเปลี่ยนสถานะไปแล้วจึงไม่สามารถรับคิวได้!");
  setRedirectLink("/res/main.php", true);
  exit();
}
query("UPDATE reservation SET status='approved' WHERE id=$reservation_id AND restaurant_id=$restaurant_id");
setSuccess("รับคิวเรียบร้อยแล้ว!");
setRedirectLink("/res/main.php", true);
